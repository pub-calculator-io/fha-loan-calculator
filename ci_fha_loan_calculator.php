...
Version: 1.0.0
Author: FHA Loan Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for FHA Loan Calculator by www.calculator.io";

function display_calcio_ci_fha_loan_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_fha_loan_calculator', 'display_calcio_ci_fha_loan_calculator' );